...
function Button({ children, disabalede, to, type, onClick }) {
  const base =
  ...
  return (
    <button disabled={disabalede} className={styles[type]}>
      {children}
    </button>
  );
}
